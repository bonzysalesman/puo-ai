...
def parse_args():
    ...
    parser.add_argument("--base", default="data/dictionary.json")
    parser.add_argument("--candidate", default="data/dictionary.enriched.json")
    parser.add_argument("--output", default="reports/enrichment_diff.md")
