...
def parse_args():
    ...
    parser.add_argument("--lexicon-out", default="lexicon.json")
    parser.add_argument("--corpus-out", default="corpus.json")
    parser.add_argument("--attestations-out", default="attestations.json")
